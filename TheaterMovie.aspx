<%@ Page Title="TheaterMovie" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TheaterMovie.aspx.cs" Inherits="WebApplication1.TheaterMovie" %>
...
<div class="container-lg py-4">
    ...
    <div class="page-header d-flex align-items-center gap-3 mb-4">
        ...
        <div>
            <h4 class="mb-0 fw-bold">Theater Movies</h4>
        </div>
    </div>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body p-4">
            <label class="filter-label">Select Theater Hall</label>
    ...
    <div class="card">
        <div class="custom-card-header d-flex align-items-center justify-content-between">
            <span><i class="bi bi-table me-2 text-primary"></i>Shows &amp; Movies for Selected Hall</span>
        </div>
            ...
            <div class="table-responsive">
                ...
                <asp:GridView ID="GridView2" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="MOVIEID1"        HeaderText="Movie ID (ref)" ReadOnly="True" SortExpression="MOVIEID1" />
                ...
                <asp:SqlDataSource ID="SqlDataSource3" runat="server"
                    ConnectionString="<%$ ConnectionStrings:ConnectionString2 %>"
                    ProviderName="<%$ ConnectionStrings:ConnectionString2.ProviderName %>"
                    SelectCommand="SELECT * FROM &quot;SHOWS&quot; S JOIN &quot;MOVIE&quot; M ON S.&quot;MOVIEID&quot;=M.&quot;MOVIEID&quot; WHERE (S.&quot;HALLID&quot; = :HALLID)">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="DropDownList1" Name="HALLID" PropertyName="SelectedValue" Type="Decimal" />
                    </SelectParameters>
                </asp:SqlDataSource>
