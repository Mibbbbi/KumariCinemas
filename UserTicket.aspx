<%@ Page Title="UserTicket" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UserTicket.aspx.cs" Inherits="WebApplication1.UserTicket" %>
...
<div class="container-lg py-4">
    ...
    <div class="page-header d-flex align-items-center gap-3 mb-4">
        ...
        <div>
            <h4 class="mb-0 fw-bold">User Tickets</h4>
        </div>
    </div>
    ...
    <div class="card">
        <div class="custom-card-header d-flex align-items-center justify-content-between">
            <span><i class="bi bi-ticket-perforated me-2 text-primary"></i>Tickets for Selected User</span>
        </div>
        <div class="card-body p-0">
            <div class="table-responsive">
                ...
                <asp:SqlDataSource ID="SqlDataSource2" runat="server"
                    ConnectionString="<%$ ConnectionStrings:ConnectionString2 %>"
                    ProviderName="<%$ ConnectionStrings:ConnectionString2.ProviderName %>"
                    SelectCommand="SELECT * FROM &quot;TICKET&quot; WHERE (&quot;USERID&quot; = :USERID)">
                    <SelectParameters>
